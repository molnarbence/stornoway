...
const experiences = [
    {
        ...
        projects: [
            ...
            },
            {
                ...
                description: 'Led the development of the internal financial tools, responsible for staging the billing requests to the finance team, '
            ...
            },
            {
                ...
                description: 'Being the SOx control owner of the financial tooling Financial and IT controls; documenting SOx control evidence provision and conducting annual audit of the bespoke financial tools of Skyscanner.',
            },
            {
                name: 'Disaster Recovery Plan for the Financial Tools',
                description: 'Established and documented the runbook for a disaster event of Financial Tools including their databases.',
                tech: ['AWS CloudFormation', 'SQL Server', 'Postgres', 'MySQL'],
            },
            {
                name: 'Python application configuration facility',
                description: 'Developed an internal python package to unify developer experience to load application configuration from various sources, including the internal secret vault solution, reducing the code complexity of the AWS Batch jobs and AWS Lambda functions written in python.'
            }
        ],
    },
    {
        ...
        projects: [
            {
                ...
                description: 'Worked on the email ingestion system that helped onboarding new customers and migrate their emails to Mimecast.',
                tech: ['.NET', 'C#'],
            },
        ],
    },
        ...
        projects: [
            {
                ...
                description: 'I\'ve organized the handover of the PIX Image Platform from the Budapest development team bringing the platform\'s development to the Bangkok HQ and further improved the main service by '
            ...
            },
            {
                ...
                description: 'I worked mainly on the Experimentation Platform\'s user interface, used by Product Owners managing setup of their A/B test runs.',
                tech: ['TypeScript', 'AngularJS'],
            },
            {
                name: 'Agoda Home Page',
                description: 'One of my first assignment included delivering the new search box oriented, responsive UI layout in 2014 August, gaining +7% revenue with a single AB test.',
        ...
        projects: [
            {
                ...
                description: 'Developed and maintained the management portal for the public email service of Vodafone Hungary offered to their mobile customers.',
    ...
    <main class="space-y-10">
        ...
        <section class="space-y-4">
            ...
            <div class="relative grid grid-cols-[1fr_5rem] gap-x-6 gap-y-12">
                ...
                <div class="pointer-events-none absolute right-0 top-0 bottom-0 w-px bg-gray-200 dark:bg-gray-800"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-3">
                            <div v-for="(p, j) in exp.projects" :key="j">
                                ...
                                <div v-if="p.tech?.length" class="text-sm text-gray-500 dark:text-gray-400">Tech: {{
                                    p.tech.join(', ') }}</div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="space-y-3">
            ...
            <ul class="flex flex-wrap gap-2">
                <li v-for="(s, i) in skills" :key="i"
                    class="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-sm">{{ s
                    }}</li>
            </ul>
        </section>
